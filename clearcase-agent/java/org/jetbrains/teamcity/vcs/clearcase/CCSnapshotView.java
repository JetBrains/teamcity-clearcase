...
public class CCSnapshotView {
  ...
  /**
   * mkview -snapshot [-tag snapshot-view-tag] [-tcomment tag-comment] [-tmode
   * text-mode] [-cachesize size] [-ptime] [-stream stream-selector] [ -stgloc
   * view-stgloc-name | -colocated_server [-host hostname -hpath
   * host-snapshot-view-pname -gpath global-snapshot-view-pname] | -vws
   * view-storage-pname [-host hostname -hpath host-stg-pname -gpath
   * global-stg-pname] ] snapshot-view-pname
   */
